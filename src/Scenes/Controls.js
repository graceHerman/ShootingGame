class Controls extends Phaser.Scene {
    ...
    create() {
        ...
        // credits
        this.creditText = this.add.text(100, 350, 'Credits:', { fontFamily: 'Arial', fontSize: 25, color: '#ffffff' });
        this.credit1Text = this.add.text(100, 400, 'kenny_animal-pack, kenny_jumper-pack for assets', { fontFamily: 'Arial', fontSize: 25, color: '#ffffff' });
        this.credit2Text = this.add.text(100, 450, ' kenny_impact-sounds for sound.', { fontFamily: 'Arial', fontSize: 25, color: '#ffffff' });
        this.credit3Text = this.add.text(100, 500, 'Used Bullet Time file by Jim Whitehead as reference for my code ', { fontFamily: 'Arial', fontSize: 25, color: '#ffffff' });
