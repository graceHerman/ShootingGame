class Start extends Phaser.Scene {
    ...
    create() {
        ...
        this.credits = this.input.keyboard.addKey("X");
        ...
        this.contText = this.add.text(280, 600, 'Press X to Credits', { fontFamily: 'Arial', fontSize: 35});
    ...
    update() {
        ...
        if (Phaser.Input.Keyboard.JustDown(this.credits)) {
            this.scene.start("credits", { prevScene: this.scene.key });
        }
